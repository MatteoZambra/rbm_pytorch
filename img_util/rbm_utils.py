...
#        train_set = [train_set[i] for i in idx]
        ...
        # it is more handy to loop over lists in the training stage
        # A list of data batches and a list of the respective labels are
        # created. Data samples are flattened
        for _data,_labels in train_set:
        ...
        for epoch in range(epochs):
            ...
            for train_batch,labels_batch in zip(data,labels):
